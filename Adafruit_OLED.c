...
*  SPI.
*/
    GPIOPinWrite(GPIOA3_BASE, 0x80, 0); // Set DC low; write command
    GPIOPinWrite(GPIOA3_BASE, 0x10, 0); // Set CS low; enable cs
    MAP_SPICSEnable(GSPI_BASE);         // enable SPI CS
    MAP_SPIDataPut(GSPI_BASE, c);
    unsigned long ulDummy;
    MAP_SPIDataGet(GSPI_BASE, &ulDummy);
    MAP_SPICSDisable(GSPI_BASE);
    GPIOPinWrite(GPIOA3_BASE, 0x10, 0x10); // Set CS high; disable cs
}
//*****************************************************************************
...
*  SPI.   
*/
    GPIOPinWrite(GPIOA3_BASE, 0x80, 0x80); // Set DC high; write data
    GPIOPinWrite(GPIOA3_BASE, 0x10, 0); // Set CS low; enable cs
    MAP_SPICSEnable(GSPI_BASE);         // enable SPI CS
    MAP_SPIDataPut(GSPI_BASE, c);
    unsigned long ulDummy;
